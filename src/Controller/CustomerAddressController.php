...
final class CustomerAddressController extends AbstractController
{
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$customerAddress->getId(), $request->getPayload()->getString('_token'))) {
